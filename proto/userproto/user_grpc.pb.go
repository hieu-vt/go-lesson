...
type UserServiceClient interface {
	GetUserByIds(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userServiceClient) GetUserByIds(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, "/userproto.UserService/GetUserByIds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	GetUserByIds(context.Context, *UserRequest) (*UserResponse, error)
}
...
func (UnimplementedUserServiceServer) GetUserByIds(context.Context, *UserRequest) (*UserResponse, error) {
...
func _UserService_GetUserByIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/userproto.UserService/GetUserByIds",
	}
